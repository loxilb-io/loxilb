...
curl -fL https://get.k3s.io | K3S_TOKEN=${NODE_TOKEN} sh -s - server --server https://192.168.80.10:6443 --disable traefik --disable servicelb --node-ip=192.168.80.12 --tls-san 192.168.80.80 --node-external-ip=192.168.80.12 --disable-cloud-controller -t ${NODE_TOKEN} --flannel-iface=eth2
