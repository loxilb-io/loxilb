...
curl -fL https://get.k3s.io | sh -s - server --node-ip=192.168.80.10 --disable servicelb --disable traefik --cluster-init --tls-san 192.168.80.80 --node-external-ip=192.168.80.10 --disable-cloud-controller --flannel-iface=eth2
