...
# Issue #1078 — SCTP multihoming secondary VIP dataplane reachability.
#
# Topology (single, uni-homed client; intentionally NOT multihomed so that the
# secondary VIP is exercised as a first-class dataplane endpoint):
#
#   c1 (10.0.3.71) --\
#                     \
#   ep1 (10.0.3.10) ---+-- br1 --- llb1 (10.0.3.17)
#                     /
#   ep2 (10.0.3.11) -/
#
# The LB rule has a primary VIP (20.20.20.1) plus two secondary VIPs
# (21.21.21.1, 22.22.22.1). c1's default gateway is llb1, so SCTP packets
# addressed directly to a secondary VIP arrive at llb1 and must be DNAT'd to a
# backend exactly like the primary VIP.
...
##Create LB rule with secondary VIPs
$dexec llb1 loxicmd create lb 20.20.20.1 --sctp=38412:38412 --secips=21.21.21.1,22.22.22.1 --endpoints=10.0.3.10:1,10.0.3.11:1 --mode=fullnat
