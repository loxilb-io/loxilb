...
curl -sfL https://get.k3s.io | INSTALL_K3S_VERSION=v1.22.9+k3s1 K3S_URL="https://${MASTER_ADDR}:6443" K3S_TOKEN="${NODE_TOKEN}" INSTALL_K3S_EXEC="--node-ip=${WORKER_ADDR} --node-external-ip=${WORKER_ADDR}" sh -
