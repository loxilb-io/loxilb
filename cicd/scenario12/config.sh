...
config_docker_host --host1 ep1 --host2 r2 --ptype phy --addr 10.10.10.3/24
config_docker_host --host1 ep2 --host2 r2 --ptype phy --addr 10.10.10.4/24
config_docker_host --host1 ep3 --host2 r2 --ptype phy --addr 10.10.10.5/24
...
##Create LB rule
$dexec llb1 loxicmd create lb 20.20.20.1 --tcp=2020:8080 --endpoints=10.10.10.3:1,10.10.10.4:1,10.10.10.5:1
$dexec llb2 loxicmd create lb 20.20.20.1 --tcp=2020:8080 --endpoints=10.10.10.3:1,10.10.10.4:1,10.10.10.5:1
#$dexec llb1 loxicmd create lb 20.20.20.1 --tcp=2020:8080 --endpoints=31.31.31.1:1,32.32.32.1:1,33.33.33.1:1
#$dexec llb2 loxicmd create lb 20.20.20.1 --tcp=2020:8080 --endpoints=31.31.31.1:1,32.32.32.1:1,33.33.33.1:1
