...
curl -fL https://get.k3s.io | sh -s - server --node-ip=192.168.82.128 --disable servicelb --disable traefik --cluster-init --node-external-ip=192.168.82.128 --disable-cloud-controller  --flannel-backend=none --disable-network-policy --cluster-cidr=172.16.219.0/24
sleep 60
