...
docker run -u root --cap-add SYS_ADMIN   --restart unless-stopped --privileged -dit -v /dev/log:/dev/log --net=host --entrypoint /bin/bash --name seastar loxilbio/seastar-dev:latest
