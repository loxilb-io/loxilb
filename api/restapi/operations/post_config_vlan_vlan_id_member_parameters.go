...
func NewPostConfigVlanVlanIDMemberParams() PostConfigVlanVlanIDMemberParams {
	...
	return PostConfigVlanVlanIDMemberParams{}
}

// PostConfigVlanVlanIDMemberParams contains all the bound params for the post config vlan vlan ID member operation
...
func (o *PostConfigVlanVlanIDMemberParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.VlanMemberEntry
...
func (o *PostConfigVlanVlanIDMemberParams) bindVlanID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
