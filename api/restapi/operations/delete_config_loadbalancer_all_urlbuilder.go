...
func (o *DeleteConfigLoadbalancerAllURL) WithBasePath(bp string) *DeleteConfigLoadbalancerAllURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteConfigLoadbalancerAllURL) Build() (*url.URL, error) {
	var _result url.URL
...
func (o *DeleteConfigLoadbalancerAllURL) String() string {
...
func (o *DeleteConfigLoadbalancerAllURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteConfigLoadbalancerAllURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteConfigLoadbalancerAllURL")
	}
