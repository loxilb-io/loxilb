...
func (o *PostConfigLoadbalancerURL) WithBasePath(bp string) *PostConfigLoadbalancerURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PostConfigLoadbalancerURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostConfigLoadbalancerURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostConfigLoadbalancerURL")
	}
