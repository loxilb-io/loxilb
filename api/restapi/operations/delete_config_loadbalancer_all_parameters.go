...
func NewDeleteConfigLoadbalancerAllParams() DeleteConfigLoadbalancerAllParams {
	...
	return DeleteConfigLoadbalancerAllParams{}
}

// DeleteConfigLoadbalancerAllParams contains all the bound params for the delete config loadbalancer all operation
...
func (o *DeleteConfigLoadbalancerAllParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
