...
type DeleteConfigLoadbalancerExternalipaddressIPAddressPortPortProtocolProtoHandlerFunc func(DeleteConfigLoadbalancerExternalipaddressIPAddressPortPortProtocolProtoParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteConfigLoadbalancerExternalipaddressIPAddressPortPortProtocolProtoHandlerFunc) Handle(params DeleteConfigLoadbalancerExternalipaddressIPAddressPortPortProtocolProtoParams, principal interface{}) middleware.Responder {
...
type DeleteConfigLoadbalancerExternalipaddressIPAddressPortPortProtocolProtoHandler interface {
	Handle(DeleteConfigLoadbalancerExternalipaddressIPAddressPortPortProtocolProtoParams, interface{}) middleware.Responder
}
