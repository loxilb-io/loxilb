...
func NewGetConfigTunnelVxlanAllParams() GetConfigTunnelVxlanAllParams {
	...
	return GetConfigTunnelVxlanAllParams{}
}

// GetConfigTunnelVxlanAllParams contains all the bound params for the get config tunnel vxlan all operation
...
func (o *GetConfigTunnelVxlanAllParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
