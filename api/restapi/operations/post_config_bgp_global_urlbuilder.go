...
func (o *PostConfigBgpGlobalURL) WithBasePath(bp string) *PostConfigBgpGlobalURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PostConfigBgpGlobalURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostConfigBgpGlobalURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostConfigBgpGlobalURL")
	}
