...
func NewGetConfigFirewallAllParams() GetConfigFirewallAllParams {
	...
	return GetConfigFirewallAllParams{}
}

// GetConfigFirewallAllParams contains all the bound params for the get config firewall all operation
...
func (o *GetConfigFirewallAllParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
