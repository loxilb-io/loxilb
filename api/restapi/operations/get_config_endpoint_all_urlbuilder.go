...
func (o *GetConfigEndpointAllURL) WithBasePath(bp string) *GetConfigEndpointAllURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetConfigEndpointAllURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetConfigEndpointAllURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetConfigEndpointAllURL")
	}
