...
func (o *GetConfigSessionulclAllURL) WithBasePath(bp string) *GetConfigSessionulclAllURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetConfigSessionulclAllURL) Build() (*url.URL, error) {
	...
	var _path = "/config/sessionulcl/all"
...
func (o *GetConfigSessionulclAllURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetConfigSessionulclAllURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetConfigSessionulclAllURL")
	}
