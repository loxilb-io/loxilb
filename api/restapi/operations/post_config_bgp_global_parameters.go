...
func NewPostConfigBgpGlobalParams() PostConfigBgpGlobalParams {
	...
	return PostConfigBgpGlobalParams{}
}

// PostConfigBgpGlobalParams contains all the bound params for the post config bgp global operation
...
func (o *PostConfigBgpGlobalParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.BGPGlobalConfig
