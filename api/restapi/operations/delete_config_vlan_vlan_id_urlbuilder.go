...
func (o *DeleteConfigVlanVlanIDURL) WithBasePath(bp string) *DeleteConfigVlanVlanIDURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteConfigVlanVlanIDURL) Build() (*url.URL, error) {
	...
	var _path = "/config/vlan/{vlan_id}"

	vlanID := swag.FormatInt64(o.VlanID)
	if vlanID != "" {
		_path = strings.Replace(_path, "{vlan_id}", vlanID, -1)
	} else {
		return nil, errors.New("vlanId is required on DeleteConfigVlanVlanIDURL")
	}
...
func (o *DeleteConfigVlanVlanIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteConfigVlanVlanIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteConfigVlanVlanIDURL")
	}
