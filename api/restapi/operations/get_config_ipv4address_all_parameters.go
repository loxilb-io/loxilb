...
func NewGetConfigIpv4addressAllParams() GetConfigIpv4addressAllParams {
	...
	return GetConfigIpv4addressAllParams{}
}

// GetConfigIpv4addressAllParams contains all the bound params for the get config ipv4address all operation
...
func (o *GetConfigIpv4addressAllParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
