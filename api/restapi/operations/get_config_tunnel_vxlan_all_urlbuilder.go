...
func (o *GetConfigTunnelVxlanAllURL) WithBasePath(bp string) *GetConfigTunnelVxlanAllURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetConfigTunnelVxlanAllURL) Build() (*url.URL, error) {
	...
	var _path = "/config/tunnel/vxlan/all"
...
func (o *GetConfigTunnelVxlanAllURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetConfigTunnelVxlanAllURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetConfigTunnelVxlanAllURL")
	}
