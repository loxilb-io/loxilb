...
func (o *PostConfigTunnelVxlanURL) WithBasePath(bp string) *PostConfigTunnelVxlanURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PostConfigTunnelVxlanURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostConfigTunnelVxlanURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostConfigTunnelVxlanURL")
	}
