...
func (o *GetConfigIpv4addressAllURL) WithBasePath(bp string) *GetConfigIpv4addressAllURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetConfigIpv4addressAllURL) Build() (*url.URL, error) {
	...
	var _path = "/config/ipv4address/all"
...
func (o *GetConfigIpv4addressAllURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetConfigIpv4addressAllURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetConfigIpv4addressAllURL")
	}
