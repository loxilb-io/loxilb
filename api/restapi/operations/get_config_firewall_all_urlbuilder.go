...
func (o *GetConfigFirewallAllURL) WithBasePath(bp string) *GetConfigFirewallAllURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetConfigFirewallAllURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetConfigFirewallAllURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetConfigFirewallAllURL")
	}
