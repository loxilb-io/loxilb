...
func NewGetConfigBgpNeighAllParams() GetConfigBgpNeighAllParams {
	...
	return GetConfigBgpNeighAllParams{}
}

// GetConfigBgpNeighAllParams contains all the bound params for the get config bgp neigh all operation
...
func (o *GetConfigBgpNeighAllParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
