...
func NewPostConfigBgpNeighParams() PostConfigBgpNeighParams {
	...
	return PostConfigBgpNeighParams{}
}

// PostConfigBgpNeighParams contains all the bound params for the post config bgp neigh operation
...
func (o *PostConfigBgpNeighParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
