...
func (o *GetConfigBgpNeighAllURL) WithBasePath(bp string) *GetConfigBgpNeighAllURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetConfigBgpNeighAllURL) Build() (*url.URL, error) {
	...
	var _path = "/config/bgp/neigh/all"
...
func (o *GetConfigBgpNeighAllURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetConfigBgpNeighAllURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetConfigBgpNeighAllURL")
	}
