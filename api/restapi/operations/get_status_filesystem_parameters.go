...
func NewGetStatusFilesystemParams() GetStatusFilesystemParams {
	...
	return GetStatusFilesystemParams{}
}

// GetStatusFilesystemParams contains all the bound params for the get status filesystem operation
...
func (o *GetStatusFilesystemParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
