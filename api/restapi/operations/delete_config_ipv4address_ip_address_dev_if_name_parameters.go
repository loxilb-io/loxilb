...
func NewDeleteConfigIpv4addressIPAddressDevIfNameParams() DeleteConfigIpv4addressIPAddressDevIfNameParams {
	...
	return DeleteConfigIpv4addressIPAddressDevIfNameParams{}
}

// DeleteConfigIpv4addressIPAddressDevIfNameParams contains all the bound params for the delete config ipv4address IP address dev if name operation
...
func (o *DeleteConfigIpv4addressIPAddressDevIfNameParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteConfigIpv4addressIPAddressDevIfNameParams) bindIfName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteConfigIpv4addressIPAddressDevIfNameParams) bindIPAddress(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
