...
func NewPostConfigEndpointParams() PostConfigEndpointParams {
	...
	return PostConfigEndpointParams{}
}

// PostConfigEndpointParams contains all the bound params for the post config endpoint operation
...
func (o *PostConfigEndpointParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
