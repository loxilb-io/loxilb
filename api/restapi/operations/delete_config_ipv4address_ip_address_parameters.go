...
func NewDeleteConfigIpv4addressIPAddressParams() DeleteConfigIpv4addressIPAddressParams {
	...
	return DeleteConfigIpv4addressIPAddressParams{}
}

// DeleteConfigIpv4addressIPAddressParams contains all the bound params for the delete config ipv4address IP address operation
...
func (o *DeleteConfigIpv4addressIPAddressParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteConfigIpv4addressIPAddressParams) bindIPAddress(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
