...
func NewGetConfigPolicyAllParams() GetConfigPolicyAllParams {
	...
	return GetConfigPolicyAllParams{}
}

// GetConfigPolicyAllParams contains all the bound params for the get config policy all operation
...
func (o *GetConfigPolicyAllParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
