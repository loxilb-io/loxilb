...
func (o *GetConfigConntrackAllURL) WithBasePath(bp string) *GetConfigConntrackAllURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetConfigConntrackAllURL) Build() (*url.URL, error) {
	...
	var _path = "/config/conntrack/all"
...
func (o *GetConfigConntrackAllURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetConfigConntrackAllURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetConfigConntrackAllURL")
	}
