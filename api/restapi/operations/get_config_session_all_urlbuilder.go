...
func (o *GetConfigSessionAllURL) WithBasePath(bp string) *GetConfigSessionAllURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetConfigSessionAllURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetConfigSessionAllURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetConfigSessionAllURL")
	}
