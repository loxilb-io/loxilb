...
func (o *PostConfigSessionulclURL) WithBasePath(bp string) *PostConfigSessionulclURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PostConfigSessionulclURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostConfigSessionulclURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostConfigSessionulclURL")
	}
