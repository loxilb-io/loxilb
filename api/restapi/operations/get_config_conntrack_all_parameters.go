...
func NewGetConfigConntrackAllParams() GetConfigConntrackAllParams {
	...
	return GetConfigConntrackAllParams{}
}

// GetConfigConntrackAllParams contains all the bound params for the get config conntrack all operation
...
func (o *GetConfigConntrackAllParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
