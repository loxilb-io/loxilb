...
func (o *PostConfigIpv4addressURL) WithBasePath(bp string) *PostConfigIpv4addressURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PostConfigIpv4addressURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostConfigIpv4addressURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostConfigIpv4addressURL")
	}
