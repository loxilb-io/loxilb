...
func (o *DeleteConfigEndpointURL) WithBasePath(bp string) *DeleteConfigEndpointURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteConfigEndpointURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteConfigEndpointURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteConfigEndpointURL")
	}
