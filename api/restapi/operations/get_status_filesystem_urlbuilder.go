...
func (o *GetStatusFilesystemURL) WithBasePath(bp string) *GetStatusFilesystemURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetStatusFilesystemURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetStatusFilesystemURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetStatusFilesystemURL")
	}
