...
func NewPostConfigFirewallParams() PostConfigFirewallParams {
	...
	return PostConfigFirewallParams{}
}

// PostConfigFirewallParams contains all the bound params for the post config firewall operation
...
func (o *PostConfigFirewallParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
