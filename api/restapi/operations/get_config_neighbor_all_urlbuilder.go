...
func (o *GetConfigNeighborAllURL) WithBasePath(bp string) *GetConfigNeighborAllURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetConfigNeighborAllURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetConfigNeighborAllURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetConfigNeighborAllURL")
	}
