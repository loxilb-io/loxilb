...
func NewPostConfigIpv4addressParams() PostConfigIpv4addressParams {
	...
	return PostConfigIpv4addressParams{}
}

// PostConfigIpv4addressParams contains all the bound params for the post config ipv4address operation
...
func (o *PostConfigIpv4addressParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.IPV4AddressEntry
