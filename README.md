...
- [kube-loxilb](https://github.com/loxilb-io/kube-loxilb): A kubernetes agent written in Go

## Layer4 or Layer7
loxilb works as a layer4 load-balancer/service-mesh by default. Although it provides great performance, at times Layer7 load-balancing is necessary in K8s. There are many good L7 proxies already available for k8s. Still, we are working on providing a great L7 solution natively in eBPF. It is a tough endeavor which should reap great benefits once completed. Please keep an eye for updates on this.
